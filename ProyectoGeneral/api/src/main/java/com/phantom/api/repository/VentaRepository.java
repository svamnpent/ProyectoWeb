...
public interface VentaRepository extends JpaRepository<Venta, Long> {
    ...
    Page<Venta> findByUsuarioIdOrderByFechaDesc(Long usuarioId, Pageable pageable);

    Optional<Venta> findByNumeroOrden(String numeroOrden);

    // Cargar la venta con sus detalles y cliente de una sola consulta (Optimización
    // JOIN FETCH)
    ...
    Page<Venta> findByKeyword(@Param("keyword") String keyword, Pageable pageable);
